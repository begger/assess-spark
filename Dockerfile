...
MAINTAINER Brian Egger <brian.egger@gmail.com>
...
ARG SPARK_BINARY_DOWNLOAD_URL=https://www.apache.org/dist/spark/spark-${SPARK_VERSION}/${SPARK_BINARY_ARCHIVE_NAME}.tgz
